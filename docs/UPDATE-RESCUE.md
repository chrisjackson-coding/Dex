...
Download the versioned bridge and its checksum from the public v1.92.0 release,
...
curl -fL \
  "https://github.com/davekilleen/Dex/releases/download/v1.92.0/dex-update-bridge-v1.92.0.py" \
  -o "$BRIDGE_DIR/dex-update-bridge-v1.92.0.py"
curl -fL \
  "https://github.com/davekilleen/Dex/releases/download/v1.92.0/dex-update-bridge-v1.92.0.py.sha256" \
  -o "$BRIDGE_DIR/dex-update-bridge-v1.92.0.py.sha256"
(
  cd "$BRIDGE_DIR"
  shasum -a 256 -c "dex-update-bridge-v1.92.0.py.sha256"
)
python3 "$BRIDGE_DIR/dex-update-bridge-v1.92.0.py" --vault "$PWD"
```

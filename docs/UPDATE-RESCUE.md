...
Download the versioned bridge and its checksum from the public v1.97.13 release,
...
curl -fL \
  "https://github.com/davekilleen/Dex/releases/download/v1.97.13/dex-update-bridge-v1.97.13.py" \
  -o "$BRIDGE_DIR/dex-update-bridge-v1.97.13.py"
curl -fL \
  "https://github.com/davekilleen/Dex/releases/download/v1.97.13/dex-update-bridge-v1.97.13.py.sha256" \
  -o "$BRIDGE_DIR/dex-update-bridge-v1.97.13.py.sha256"
(
  cd "$BRIDGE_DIR"
  shasum -a 256 -c "dex-update-bridge-v1.97.13.py.sha256"
)
python3 "$BRIDGE_DIR/dex-update-bridge-v1.97.13.py" --vault "$PWD"
```

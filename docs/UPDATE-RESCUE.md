...
Download the versioned bridge and its checksum from the public v1.97.5 release,
...
curl -fL \
  "https://github.com/davekilleen/Dex/releases/download/v1.97.5/dex-update-bridge-v1.97.5.py" \
  -o "$BRIDGE_DIR/dex-update-bridge-v1.97.5.py"
curl -fL \
  "https://github.com/davekilleen/Dex/releases/download/v1.97.5/dex-update-bridge-v1.97.5.py.sha256" \
  -o "$BRIDGE_DIR/dex-update-bridge-v1.97.5.py.sha256"
(
  cd "$BRIDGE_DIR"
  shasum -a 256 -c "dex-update-bridge-v1.97.5.py.sha256"
)
python3 "$BRIDGE_DIR/dex-update-bridge-v1.97.5.py" --vault "$PWD"
```

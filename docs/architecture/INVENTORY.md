...
<!-- Content SHA-256: f268d1bd5cb9e382ebe56c9e442a236b415936be4baf4cb3442b67535c7feb4c -->
...
| `dex-onboarding-mcp` | `core/mcp/onboarding_server.py` | 16 | no | `check_onboarding_complete`, `cleanup_qa_session`, `finalize_onboarding`, `forget_nudge_events`, `generate_nudge_calendar`, `get_nudge_plan`, `get_onboarding_status`, `prepare_entity_page_offer`, `record_nudge_events`, `respond_to_entity_page_offer`, `run_first_week_analysis`, `save_calendar_selection`, `set_entity_creation_default`, `start_onboarding_session`, `validate_and_save_step`, `verify_dependencies` |

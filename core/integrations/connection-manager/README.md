...
| Catalog destination drifts away from an approved origin | Pinned credential-bearing requests fail closed before sending. Connections without a pin require explicit `--confirm-provider` consent and are never auto-probed. |

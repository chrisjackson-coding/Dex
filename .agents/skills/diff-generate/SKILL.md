...
<!-- Generated from `.claude/skills/diff-generate/SKILL.md` by `scripts/generate-agents-skills.py`. Do not edit. -->
...
```
python3 .agents/skills/diff-generate/scripts/publish_diff.py link --code ABC123
```

3. Once the terminal is linked, run:

```
python3 .agents/skills/diff-generate/scripts/publish_diff.py publish <path-to-yaml>
```

...
* **Setup refuses unsafe paths before it touches the vault.** Onboarding and room changes now reject links or malformed paths that could send a write outside the vault, and their receipts include every profile, folder, and skill file they actually changed.
